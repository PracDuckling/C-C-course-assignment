...
int main(){
    ...
    //1
    printf("\n\nQ1\n\n");
    for (int i = 0;i<5;i++) printf("MySirG ");
    ...
    //4
    printf("\n\nQ4\n\n");
    for(int i=1;i<=10;i++) printf("%d ", i*2-1);

    //5
    printf("\n\nQ5\n\n");
    for (int i = 10;i>=1;i--) printf("%d ", i*2-1);
    ...
    //7
    printf("\n\nQ7\n\n");
    for(int i=10;i>=1;i--) printf("%d ", 2*i);
    ...
    //9
    printf("\n\nQ9\n\n");
    for(int i=1;i<=10;i++) printf("%d ", i*i*i);
